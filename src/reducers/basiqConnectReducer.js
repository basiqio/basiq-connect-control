...
export default (state = initialState, action) => {
    ...
    switch (action.type) {
        case actionTypes.NAVIGATE_TO:
            ...
            if ((newState.currentPage === pages.MfaPage || newState.currentPage === pages.ConnectResultPage) && state.error) {
        ...
        case actionTypes.FILE_UPLOAD_STARTED:
            ...
            let statements = state.statements.filter(({
                id
            }) => id !== action.value.fileId);
        ...
        case actionTypes.BANK_CONNECT_FAILED:
            ...
            newState.connectError = action.value;
            break;
        ...
        case actionTypes.FILE_REMOVED:
            newState.statements = state.statements.filter(({
                id
            }) => id !== action.value);
            break;
